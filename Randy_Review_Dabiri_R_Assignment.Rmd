...
### I loved the entire code, short and well embedded with good graphs. The only issue noticed:

The code was clustered : do space them out as it helps visualize and to follow through.

The Loops to run the descending and ascending order of either maize and teosinte were running into errors. Do check that or inform user what required packages are needed to run them.
